...
| คอมโพสิเตอร์ D3D11 | ผ่าน type-check กับ stub headers **ยังไม่เคย build จริง** |
| HLSL shaders | **ยังไม่เคยผ่านคอมไพเลอร์** |
| ไดรเวอร์ IddCx | **ยังไม่เคยผ่านคอมไพเลอร์ และตรวจสอบได้น้อยที่สุด** |
