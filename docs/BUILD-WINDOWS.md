...
**วิธีที่ 1 — CLI แบบออฟไลน์ (ไม่ต้องติดตั้งอะไรเลย)**

นี่คือวิธีที่เร็วที่สุดในการดูว่าฟิลเตอร์นี้ให้ผลอย่างไรกับ *ภาพของคุณเอง*
ใช้แค่ Python:

```powershell
pip install numpy pillow
python tools\visual4k.py demo demo.png                    # scene สังเคราะห์
python tools\visual4k.py compare shot-4k.png cmp.png      # ภาพของคุณเอง
```

`compare` จะซ้อนสามภาพให้ดู (point sample / bilinear / visual4k) พร้อมตัวเลข PSNR
และ SSIM

**วิธีที่ 2 — คอมโพสิเตอร์กับจอที่สอง**

คอมโพสิเตอร์ทำงานกับจออะไรก็ได้ที่ความละเอียดสูงกว่าพาเนล ถ้าคุณมีจอที่สองที่
ความละเอียดสูงกว่า:
...
> **หมายเหตุ:** การตั้งเดสก์ท็อปเป็น 3840×2160 ด้วย NVIDIA DSR แล้วรัน
> `visual4k-host` ทับ **ใช้ไม่ได้** บนจอเดียว เพราะหน้าต่างของคอมโพสิเตอร์เองก็อยู่บน
> เดสก์ท็อป 4K นั้น แล้วถูก DSR ย่อซ้ำอีกรอบ — เป็นวงกลม ถ้าจะทดสอบฟิลเตอร์ของ
> โปรเจกต์นี้บนจอเดียวโดยไม่ลงไดรเวอร์ ให้ใช้วิธีที่ 1
